        ...
        <div class="page_sign-up">
            ...
            <div class="sign-up">
				<div class="sign-up_text">
					<div class="sign-up_title">Давайте войдем в систему</div>
					<div class="sign-up_subtitle">У вас нет учетной записи?<router-link class="enter" to="/registration">Зарегистрироваться</router-link></div>
				</div>
				<form @submit.prevent="submit"  class="sign-up_form">
					...
					<div class="policy">
						<div class = "policy_inner">
							<input class ="checkbox" type ="checkbox" width="24px" height="24px">
							<div class="policy_text">Запомнить меня</div>
						</div>
					</div>
					<div class = "registration__button">
						<button width = "584px" height = "20px" class="registration" type="submit">Войти</button>
					</div>
					<div class = "or">
